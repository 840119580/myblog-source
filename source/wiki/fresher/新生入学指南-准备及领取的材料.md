...
<div class="tag-plugin note" color="light">
    <div class="body">
        <p style="text-align:left;color: #196fa2;">&emsp;&emsp;每个月生活费建议1500-2000左右，如果你购买需求大，家庭条件比较好，可以上升到2500左右。当然大部分人基本都是2000左右，剩下一些资金用于救急或者是其他需求。</br>&emsp;&emsp;但对于普通家庭来说最高不建议超过3000，过于多的生活费可能会容易养成不良的生活习惯。</br>&emsp;&emsp;另外：开学第一个月建议除了学费之外，带两个月的生活费来学校，第二个月正常生活费就行。因为开学需要置办的东西比较多。</p>
    </div>
</div>

### {% quot 被褥床垫相关 %}

&emsp;&emsp;学校{% mark color:warning 不统一配备%}床上用品及生活用品，新生可自带☆或根据自愿原则报到时从直销商处购买成套或散件卧具。
&emsp;&emsp;(学校按照北京市教委和市质监局要求，通过招标形式确定厂家和价格，包括被子、褥子、垫子、床单、被罩、枕巾、枕头、枕套和蚊帐)。
<div class="tag-plugin note" color="light">
    <div class="body">
    <p style="text-align:left;color: red;"><b>床铺尺寸为:</b></p>
        <p style="text-align:left;color: green;">&emsp;&emsp;<font size=4>{% mark color:red 小营校区 90cm * 200cm %}</font></br>&emsp;&emsp;<font size=4>{% mark color:blue 沙河校区 90cm * 210cm %}</font></br>&emsp;&emsp;不太建议购买学校的被褥，如果有条件，建议去实体店商场购买，对于贴身住的东西一定要质量好，不要凑合一下。</br>&emsp;&emsp;线下购买可以摸到质量好不好。另外不建议购买弹簧床垫（大型的）。</br>&emsp;&emsp;避免不了有可能要搬宿舍或者别的奇怪的事，万一要是搬行李，大的弹簧床垫没法弯折。</p>
    </div>
</div>

### {% quot 必备的证件照 %}

&emsp;&emsp;开学时记得带上自己的证件照，{% mark color:warning 大小要求一寸，颜色最好是白底 %}，但是实在没有蓝底色也可以。宿舍入住会需要交一张照片，其他也有可能需要照片的。(最好有电子版的证件照哦，以后避免不了会用到的哈)
<div class="tag-plugin note" color="light">
    <div class="body">
        <p style="text-align:left;color: #ff5724;">&emsp;&emsp;开学统一带着拍一张一寸照片，蓝底色自带双面胶(但是有点丑)。</br>&emsp;&emsp;学生卡(饭卡)的默认照片是高考准考证的照片，学生证默认照片是开学学校采集的照片。</p>
    </div>
</div>
...
<div class="tag-plugin note" color="green">
    <div class="body">
        <p style="text-align:center;color: green;">{% link http://bistu.huafengfar.com:8090/GetXH.aspx 点击此处查询学号 icon:/assets/wiki/fresher/caiselogo.png %}</p>
    </div>
</div>
